...
<head>
    ...
    <title>SHOPACC2016 | Dashboard</title>
            ...
            <ul class="sidebar-menu">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="pages/forms/general.html"><i class="fa fa-circle-o"></i>Danh sách tài khoản</a>
                        </li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 col-xs-6">
                                    <div class="description-block border-right">
                                        ...
                                        <h5 class="description-header">+<?= number_format($moneyday, 0, '.', '.') ?>
                                            <sup class="text-muted">vnđ</sup></h5>
                                ...
                                <div class="col-sm-3 col-xs-6">
                                    <div class="description-block">
                                        ...
                                        <h5 class="description-header">+<?= number_format($moneyadd, 0, '.', '.') ?>
                                            <sup class="text-muted">vnđ</sup></h5>
                                ...
                                <div class="col-sm-3 col-xs-6">
                                    <div class="description-block border-right">
                                        ...
                                        <h5 class="description-header">+<?= number_format($moneymoth, 0, '.', '.') ?>
                                            <sup class="text-muted">vnđ</sup></h5>
                                ...
                                <table id="leagueoflegends" class="table no-margin">
                                    ...
                                    <?php foreach ($querylmht as $row): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="item item-1x bg-crystal-op">
                                                    <img alt="" class="img-responsive"
                                                         src="assets/img/rank/base_icons/<?= $row['rank'] ?>.png"/>
                                                </div>
                                            </td>
                                            <td><span class="text-danger"><?= number_format($row['gia']) ?>  <sup
                                                            class="text-muted">vnđ</sup></span></td>
                                            <td><strong><span
                                                            class="text-success"><?= $row['trangthai'] ?></span></strong>
                                            </td>
                                            <td><a href="admin/delete/<?= $row['id'] ?>" onclick='return xacnhan();'
                                                   class="btn btn-sm btn-danger btn-flat">Xóa</a></td>
                                        </tr>
                                    <?php endforeach; ?>
                                    </tbody>
                                </table>
